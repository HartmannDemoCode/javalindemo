...
class PersonHandlerTest {
    ...
    private Map<String, IJPAEntity> entities;
...
//                .header("Authorization", adminToken)
                ...
                .body("address", equalTo("Hansvej 1, 2300 København S"));
    }
...
//                .pathParam("id", p1.getId()).when()
                ...
                .body("phones", hasItems(hasEntry("number", "11111111"), hasEntry("number", "20666666")));
    }
